      ...
      <Form method='post'>
        ...
        <div class="mb-2 row">
          <div className='col-10'>
            ...
            {data ? (
              <input type="number" onChange={handleJumlah} min='1' max={(+data?.stok) - 1} step='0.1' name="jumlahKeluar" class="form-control" required />
            ) : <input type="number" min='1' max={(+data?.stok) - 1} step='0.1' name="jumlahKeluar" class="form-control" disabled />}
          </div>
          <div className='col-2'>
